...
public class TruckDriverDAOTest {
    static PGDataSource ds = PGDataSource.DATA_SOURCE;
    static PGDAOFactory daof;
    private TruckDriver dummy;
    private LocalDate date = LocalDate.now();

    @BeforeClass
    public static void setupClass() {
        daof = new PGDAOFactory( ds );
        daof.registerMapper( TruckDriver.class, new TruckDriverMapper() );
    }
    ...
    public void dummyClass() {
        ...
        dummy = new TruckDriver( 1, date, 1);
    }

    @Test
    public void t00Size() {
        DAO<Integer, TruckDriver> edao = daof.createDao( TruckDriver.class );
...
//        fail( "t method t00Size reached its end, you ca remove this line when you aggree." );
    ...
    public void t02GetAll() {
        DAO<Integer, TruckDriver> edao = daof.createDao( TruckDriver.class );
        Collection<TruckDriver> el = edao.getAll();
