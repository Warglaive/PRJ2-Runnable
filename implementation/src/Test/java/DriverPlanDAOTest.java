...
public class DriverPlanDAOTest {

    static PGDataSource ds = PGDataSource.DATA_SOURCE;
    static PGDAOFactory daof;
    private DriverPlan dummy;

    @BeforeClass
    public static void setupClass() {
        daof = new PGDAOFactory( ds );
        daof.registerMapper( DriverPlan.class, new DriverPlanMapper() );
    }
    ...
    public void dummyClass() {
        ...
        dummy = new DriverPlan(1, dummyRange );
    }

    @Test
    public void t00Size() {
        DAO<Integer, DriverPlan> edao = daof.createDao( DriverPlan.class );
...
//        fail( "t method t00Size reached its end, you ca remove this line when you aggree." );
    ...
    public void t02GetAll() {
        DAO<Integer, DriverPlan> edao = daof.createDao( DriverPlan.class );
        Collection<DriverPlan> el = edao.getAll();
